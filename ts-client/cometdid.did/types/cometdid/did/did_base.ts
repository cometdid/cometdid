...
function createBaseUserOauth(): UserOauth {
  return { creator: "", orgId: 0, name: "", avatar: "", did: "" };
}

export const UserOauth = {
  encode(message: UserOauth, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.creator !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): UserOauth {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseUserOauth();
  ...
  toJSON(message: UserOauth): unknown {
    const obj: any = {};
  ...
  fromPartial<I extends Exact<DeepPartial<UserOauth>, I>>(object: I): UserOauth {
    const message = createBaseUserOauth();
